...
The Lebron data set was originally posted at:
...
The 13 plots which are all produced automatically are:

Accuracy by model and resample

![Accuracy by model and resample <br>](Accuracy_by_model_and_resample.png){width="700"}
...
Correlation of the data by circle size and color

![Correlation by circle size and color](Correlation_by_circle_and_color.png){width="700"}

Correlation of the data by number and color

![Correlation by number and color](Correlation_by_number_and_color.png){width="700"}
...
![Overfitting by model and resample](Overfitting_by_model_and_resample.png){width="700"}

Pairwise scatterplots

![Pairwise scatterplots and barcharts](Pairwise_scatterplots.png){width="700"}
